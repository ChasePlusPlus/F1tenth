...
import random
from math import pi,pow,atan2,sqrt,hypot
...
class ControlTurtlesim():
    ...
    def __init__(self):
        ...
        linVel = 0
        angVel = 0
        goalx = input("Set your x goal:")
        goaly = input("Set your y goal:")
        tol = input("Tolerance:")
        ...
        turtle1_teleport_absolute(5.544445,5.544445,0) #sets it to center of screen

        #clear background after teleport
        rospy.set_param('/background_b',50)
